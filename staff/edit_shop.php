                ...
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">อัพเดทข้อมูลร้านค้า</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="pass_sp" placeholder="กรุณากรอกข้อมูล" value="<?php echo"$sp_pass";?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">

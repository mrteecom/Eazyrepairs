...
if($prov_add){
	...
	$sql="update shop set  pro_sp= '$prov_add', ampher_sp= '$amp_add', dis_sp= '$dis_add' where id_sp='$id_sp' ";
	$result=mysql_db_query($dbname,$sql);
}
	$sql2="update shop set sp_pass='$pass_sp', sp_name='$name_sp', sp_tax= '$tax_sp', sp_add = '$add_sp', pos_sp = '$post_add', sp_phone ='$phone_sp', sp_email= '$email_sp', sp_fb ='$fb_sp', sp_line= '$line_sp' where id_sp='$id_sp' ";
	$result2=mysql_db_query($dbname,$sql2);

...
$id_sc=$_GET['id_edit'];
$sql="SELECT * FROM  sub_class sb WHERE sb.id_sc='$id_sc' ";
                ...
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">แก้ไขข้อมูลรุ่น</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form method="POST" action="edit.php?id=<?php echo"$id_sc";?>"
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <span id="type_dex">
                                                <select class="form-control" name="type_dex">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span id="class_dex">
                                                <select class="form-control" name="class_dex">
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="sub_class_dex"
                                                value="<?php echo "$sc_name";?>" required>
                                        </div>
                                    </div>
                                </div>
                        </div>
...
function dochange(src, val) {
    ...
    req.open("GET", "../inc/auto_select.php?data=" + src + "&val=" + val); //สร้าง connection
    // req.setRequestHeader("Content-Type", "application/x-www-form-urlencoded;charset=utf-8"); // set Header
    req.send(null); //ส่งค่า
}

window.onLoad = dochange('type_dex', -1);
</script>

...
<?php
    ...
    $val = $_GET['val'];
         ...
         if ($data=='type_dex') {
              ...
              echo "<select class='form-control input-lg' name='type_dex' onChange=\"dochange('class_dex', this.value)\">";
              ...
              echo"</div>";
         } else if ($data=='class_dex') {
              echo"<div class='form-group'>";
              echo "<select class='form-control input-lg' name='class_dex' onChange=\"dochange('sub_class_dex', this.value)\">";

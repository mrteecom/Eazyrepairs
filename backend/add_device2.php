...
$id =$_GET[id];
$status =$_GET[status];
//echo "$sess_idshop// $id_cus // <br> $type_dev// $class_dev //$sub_class_dev // $ot_class_dev  <br> $color_dev // $id_sp ";
...
echo "<br> $type_name // $class_name // $sc_name // $sub_class_dev2";
	...
	$sql="insert into device values('','$id_cus','$sess_idshop','$type_name','$class_name','$sub_class_dev2','$color_dev','$imei_dev','$serial_dev','1','$datetime')";
	...
	$sql2="select * from device where id_sp='$sess_idshop' and id_cus='$id_cus' ";
	...
	while($r2 = mysql_fetch_array($result2)){
      $id_devi=$r2[id_devi];
		...
		echo "<h3>ไม่สามารถสมัครเพิ่มข้อมูลอุปกรณ์ได้</h3>"; exit();
	}

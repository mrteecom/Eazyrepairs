            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form name="form1" method="POST" action="edit_ser2.php?id_ser=<?php echo"$id_ser";?>&id_cus=<?php echo"$id_cus";?>&id_devi=<?php echo"$id_devi";?>">
<!------------------------------------------ข้อมูลลูกค้า----------------------------------->
                                <div class="row">
                                    <div class="col-sm-6">
...
<!------------------------------------------ข้อมูลอาการเสีย----------------------------------->
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="กรุณากรอกข้อมูล" name="ser_detail" value="<?php echo"$ser_detail";?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <!-- textarea -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>ราคา</label>
                                            <input type="number" class="form-control" id="price_ser"  name="price_ser" value="<?php echo"$ser_price";?>"> 
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            <label>ราคา</label>
                                            <input type="number" class="form-control"  id="price_ser"  name="price_ser" onkeyup="fncSum();" value="<?php echo"$ser_price";?>"> 
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            <label>Vat</label>
                                            <input type="number" class="form-control" name="vat_ser" id="vat_ser" value="<?php echo"$ser_price2";?>" readonly> 
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            <label>ราคาสุทธิ</label>
                                            <input type="number" class="form-control" name="sum_ser" id="sum_ser" value="<?php echo"$ser_netprice";?>" readonly > 
                                        </div>
                                    </div>
                                    <?php  }  ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="tech_ser" value="<?php echo"$ser_tech";?>">
                                        </div>
                                    </div>
                                </div>                                

                                <div class="card-footer">
                                    <button type="button"  onclick="window.location.href='repair.php?id_ser=<?php echo"$id_ser";?>&id_cus=<?php echo"$id_cus";?>&id_devi=<?php echo"$id_devi";?>'"  class="btn btn-danger">ย้อนกลับ</button>

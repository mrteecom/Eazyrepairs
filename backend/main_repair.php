...
<div class="content-wrapper">
                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb float-sm-right">
                        <a class="btn btn-app" href="add_repair.php">
                            <i class="fas fa-plus"></i> ใบแจ้งซ่อม
                        </a>
                    </ol>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">รายการใบแจ้งซ่อม </h3>
                        </div>
                        <!-- /.card-header -->
    ...
    where customer.id_sp = $sess_idshop and service.ser_status = '1' ";
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn" data-toggle="modal"
                                                ...
                                                <br>Serial No : <?php echo "$devi_serial_no";?><br> สีเครื่อง :
                                                <?php echo "$devi_color";?> </a>
                                        </td>
                                        <td class="text-center"><?php echo number_format($ser_price, 2); ?></td>
                                        <?php if($cus_email){ ?>
                                        <td class="text-center"><?php //echo "$cus_email"; ?>
                                            <a href="#?id_ser=<?php echo"$id_ser";?>&id_cus=<?php echo"$id_cus";?>"
                                                class="btn btn-block btn-default"><i class="fas fa-mail-bulk"></i> </a>
                                        </td>
                                        <?php }else{ ?>
                                        ...
                                        <td class="text-center">
                                            <a href="update_ser.php?id_ser=<?php echo"$id_ser";?>&stu=2"
                                                class="btn btn-info btn-block"><i class="fas fa-check-circle"></i></a>
                                        </td>
                                        <td class="text-center">
                                            <a href="repair.php?id_ser=<?php echo"$id_ser";?>&id_cus=<?php echo"$id_cus";?>&id_devi=<?php echo"$id_devi";?>"
                                                class="btn btn-warning btn-block"><i class="fas fa-edit"></i></a>
                                        </td>

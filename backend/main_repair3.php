...
<?php
    ...
    where customer.id_sp = $sess_idshop and (service.ser_status = '4' or service.ser_status = '5')";
...
<?php           if($ser_status == 4){ ?>
                                        ...
                                        <td class="text-center">
                                            <a href="update_ser.php?id_ser=<?php echo"$id_ser";?>&stu=5&id_sp=<?php echo"$sess_idshop";?>&price=<?php echo"$ser_netprice";?>" class="btn btn-danger btn-block"><i class="fas fa-dollar-sign"></i></a>
                                        </td>
                                         <td class="text-center">
                                            <button type="button" class="btn btn-success btn-block" disabled><i class="fas fa-cloud-download-alt"></i></button>
                                        </td>
...
<?php           } //end if?>
                                        <td class="text-center">
                                            <a href="update_ser.php?id_ser=<?php echo"$id_ser";?>&stu=2" class="btn btn-warning btn-block"><i class="fas fa-history"></i></a>
                                        </td>
                                    </tr>
      <!-- .modal -->

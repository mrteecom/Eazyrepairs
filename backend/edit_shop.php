...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>ข้อมูล<?php //echo"$sp_fname/$sess_idshop"; ?></h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form method="POST" action="edit_shop1.php" enctype="multipart/form-data" >
<!--                                
                                <div class="row">
                                    <div class="col-sm-6">
...
-->
                                <div class="row" >
                                    <div class="col-sm-12">
                                        <div class="text-center">
                                            <img src="images/<?php echo"$sp_logo";?>" class="img-circle" width="100" hight="100" >
                                        </div>
                                    </div>
                                </div>
                                <div class="row" >
                                ...
                                <div class="row" >                                   
                                    <div class="col-sm-12" >
                                        <div class="page-header text-center" >
                                            <h5> เลขที่ผู้เสียภาษี <?php echo"$sp_tax";?></h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="row" >                                   
                                    <div class="col-sm-12" >
                                        <div class="page-header text-center" >
                                            <h5> ที่อยู่ <?php echo"$sp_add  ต.$dis_sp  อ.$ampher_sp จ.$pro_sp  $pos_sp";?></h5>
                                        </div>
                                    </div>
                                </div>    
                                <div class="row" >                                   
                                    <div class="col-sm-12" >
                                        <div class="page-header text-center" >
                                            <h5> เบอร์โทรศัพท์ : <?php echo"$sp_phone  Email : $sp_email";?></h5>
                                        </div>
                                    </div>
                                </div>                               
                                <div class="row" >                                   
                                    <div class="col-sm-12" >
                                        <div class="page-header text-center" >
                                            <h5> Facebook : <?php echo"$sp_fb  Line : $sp_line";?></h5>
                                        </div>
                                    </div>
                                </div>      
...
-->                                
                                <div class="card-footer">
                                    ...
                                    <button type="submit" class="btn btn-warning float-right">แก้ไขข้อมูล</button>
                                </div>
                            </form>
                        </div>
                        <!-- /.card-body -->

...
<table border="1">
  <tbody>
    <tr>
      ...
      <td colspan="2"><b style="text-align:center;font-size:25px;">ใบเสร็จรับเงิน</b><br>&nbsp;<b>เลขที่ใบเสร็จรับเงิน : </b>{$code2_ser} / {$code_ser}<br><b>&nbsp; เลขประจำตัวผู้เสียภาษี : </b>{$sp_tax}<br><b>&nbsp; วันที่ออกใบกำกับภาษี : </b>{$date_sch1}</td>
    </tr>
...
$pdf->Cell(10,0, 'ต้นฉบับ','B', 1, 'L');
$pdf->write1DBarcode($code2_ser, 'C128', '', '', '', 18, 0.4, $style, 'N');

$pdf->Ln(2);
$pdf->writeHTMLCELL(0, 0, '', '', $html, 0, 1, 0, true, '', true);
// ข้อมูลที่จะแสดงในเนื้อหา
$pdf->Cell(10,0, 'สำเนา','B', 1, 'L');
$pdf->write1DBarcode($code2_ser, 'C128', '', '', '', 18, 0.4, $style, 'N');
